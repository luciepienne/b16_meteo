...
def test_meteo_api():
    ...
    assert data[0]['humidity'] >= 20, "Unexpected humidity value in the first forecast entry"
    assert data[0]['T']['value'] <= 50.0, "Unexpected temperature value in the first forecast entry"
